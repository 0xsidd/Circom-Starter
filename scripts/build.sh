...
snarkjs groth16 setup ../${circuit_file}.r1cs pot12_final.ptau multiplier2_0000.zkey
snarkjs zkey contribute ${circuit_file}_0000.zkey multiplier2_0001.zkey --name="1st Contributor Name" -v
